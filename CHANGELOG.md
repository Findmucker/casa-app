...
### Added
- **Cyberpunk 2077 theme** — selectable dark theme with angular UI, scan lines, cyan/yellow/red neon colors, glitch animations, monospace font
- **Theme selector in menu** — new "🎨 Temas" category button with grid of available themes
- **Theme persistence** — selected theme saved to localStorage, persists across sessions
- **Auto theme option** — returns to time-based theme system (morning/afternoon/dusk/night)

### Changed
- **Menu layout** — Communication button removed, History moved into Settings sub-panel
- **Category buttons** — now 3 columns: Themes | House | Settings

### Removed
- **Communication category** — redundant, History is now in Settings
