...
- Installable Android app packaged as a Trusted Web Activity (TWA)
- Verified Android deep links and delegated browser notifications
...
- **Android:** Trusted Web Activity generated by Bubblewrap, API 23+
...
npm run android:verify # Check TWA/web/generated config alignment
```
...
phone installation, Digital Asset Links, signing, and Play release instructions.

## Project Structure

```
casa-app/
├── android/                 # Bubblewrap-generated Android/TWA Gradle project
├── app/
│   ├── .well-known/assetlinks.json/ # Android domain verification response
...
├── public/
│   ├── manifest.json         # PWA and Android install manifest
...
The Android shell always opens the production Vercel origin, so web releases stay
server-backed and do not require repackaging the APK. Full-screen TWA verification
also requires `ANDROID_SHA256_CERT_FINGERPRINTS` in Vercel; see
[docs/ANDROID.md](docs/ANDROID.md#digital-asset-links-and-full-screen-verification).
