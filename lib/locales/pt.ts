export const pt = {
  ...
  // Weather
  "weather.title": "Tempo",
  "weather.loading": "A ver o tempo...",
  "weather.offline": "Não foi possível atualizar a previsão.",
  "weather.now": "Agora",
  "weather.cached": "Dados guardados",
  "weather.todayHourly": "Hoje — hora a hora",
  "weather.nextDays": "Próximos dias",
  "weather.location.active": "Localização ativa",
  "weather.location.dialog": "Escolher localização",
  "weather.location.current": "Localização atual",
  "weather.location.useCurrent": "Usar localização atual",
  "weather.location.locating": "A obter localização...",
  "weather.location.permissionDenied": "A localização está bloqueada nas permissões do browser.",
  "weather.location.favorites": "Favoritos",
  "weather.location.noFavorites": "Ainda não tens localizações favoritas.",
  "weather.location.search": "Pesquisar localizações",
  "weather.location.searchLabel": "Nome da cidade ou localidade",
  "weather.location.searchPlaceholder": "Ex.: Porto, Paris, Tóquio",
  "weather.location.searching": "A pesquisar...",
  "weather.location.noResults": "Nenhuma localização encontrada.",
  "weather.location.results": "Resultados",
  "weather.location.addFavorite": "Adicionar aos favoritos",
  "weather.location.removeFavorite": "Remover dos favoritos",
  "weather.location.useDefault": "Usar Óbidos (predefinição)",
  "weather.location.errorDenied": "Permissão de localização recusada. Podes pesquisar uma localidade manualmente.",
  "weather.location.errorUnavailable": "Não foi possível obter a localização atual.",
  "weather.location.errorSearch": "Não foi possível pesquisar localizações.",
  "weather.location.errorLimit": "Podes guardar até 10 localizações favoritas.",
  "weather.location.errorLoad": "Não foi possível carregar as preferências de localização.",
  "weather.location.errorSave": "Não foi possível guardar as preferências de localização.",
