...
export const COISINHAS_CATEGORIES: Record<string, string[]> = {
  ...
  "🛠️ Arranjos & Bricolage": ["lâmpada", "pilhas", "parafuso", "tinta", "pincel", "fita", "cola", "martelo", "chave de fendas", "berbequim", "fita métrica", "pregos", "buchas", "silicone", "lixa", "serra", "nível", "alicate", "chave inglesa", "extensão elétrica", "tomada", "interruptor"],
